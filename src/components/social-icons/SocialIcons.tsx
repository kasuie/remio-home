 ...
 * @LastEditors: kasuie
 * @LastEditTime: 2024-05-22 17:56:53
 * @Description:
 */
      ...
      <ul className="relative m-0 flex flex-wrap justify-center gap-6 md:gap-9">
        {coverData.map((v: any, index: number) => {
          return (
            ...
            >
              <span className="mio-tooltip group-hover:pointer-events-auto group-hover:visible group-hover:bottom-[-60px] group-hover:opacity-100">
                {v.title}
              </span>
              {v.icon && v.icon()}
            </li>
